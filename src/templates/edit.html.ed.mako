...
<form action="/${model_name}s/update/<@@=controller._${model_name}.id@@>" class="edit_${model_name}" id="edit_${model_name}_<@@=controller._${model_name}.id@@>" method="post">
...
<a href="/${model_name}s/show/<@@=controller._${model_name}.id@@>">Show</a> |
